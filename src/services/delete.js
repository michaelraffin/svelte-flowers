...
export const crudProduct = async(item,isDelete,source)=>{
    ...
    let className = source === undefined ?'Inventory' :source
    const deleteUrl = `${globalUrl}/delete/${className}`
    const updateUrl = 'https://www.smestoreph.com/updateAdmin/Product/'
    const url =  isDelete ?  deleteUrl : updateUrl
    console.log('url',url)
